...
#import "NSFileManager+LVYAdditions.h"
...
@interface LVYBaseCameraController () <AVCaptureFileOutputRecordingDelegate>
...
@implementation LVYBaseCameraController
...
didFinishRecordingToOutputFileAtURL:(NSURL *)outputFileURL
	...
	if (error) {
		...
		__weak LVYBaseCameraController *weakSelf = self;
